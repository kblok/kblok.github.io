...
I also want to create a Puppeteer-Sharp [CLI](https://docs.microsoft.com/en-us/dotnet/core/tools/global-tools) so it's easier for devs to download Chromium without adding extra code in their apps.
