...
permalink: /blog/creating-whatsapp-bot-puppeteer-sharp
redirect_from:
  - /blog/creating-whatsapp-bot-puppteer-sharp
...
Related: [Puppeteer-Sharp on Docker](/blog/puppeteer-sharp-docker) if you want to host something like this, [Azure Functions](/blog/running-puppeteer-sharp-azure-functions), and [PDF generation](/blog/pdf-generators-benchmark) if you're here for the "control a real Chrome from .NET" idea.
